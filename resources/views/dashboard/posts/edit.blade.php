...
<div class="col-lg-8 mb-5">
    <form method="post" action="/dashboard/posts/{{ $post->slug }}" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <input type="text" value="{{ old('title' , $post->title ) }}" class="form-control @error('title') is-invalid @enderror" id="title" name="title" autofocus required>
          @error('title') 
        ...
        <div class="mb-3">
          ...
          <input type="hidden" nsme="oldImage" value="{{ $psot->image }}" >
          @if($post->image)
            <img src="{{ asset('storage/' . $post->image) }}" class="img-preview img-fluid mt-2 col-sm-6">
          @else
